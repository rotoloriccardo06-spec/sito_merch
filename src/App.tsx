...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col selection:bg-orange-500 selection:text-white">
      ...
      <main className="flex-1">
        ...
        <section id="prodotti" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
            <h2 className="font-sans font-extrabold text-3xl sm:text-4xl text-slate-900 tracking-tight uppercase">
              Equipaggiamento Selezionato
            </h2>
            <div className="w-12 h-1.5 bg-orange-500 mx-auto rounded-full" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24 pt-16 border-t border-gray-200/80">
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h4 className="font-sans font-bold text-base text-slate-900">SPEDIZIONE PRIORITARIA GESTITA</h4>
                <p className="text-xs sm:text-sm text-gray-500 mt-1 leading-relaxed">Consegne rapide con corriere espresso in tutta Italia e tracking del volo.</p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h4 className="font-sans font-bold text-base text-slate-900">PAGAMENTI SICURI CRITTOGRAFATI</h4>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h4 className="font-sans font-bold text-base text-slate-900">SERVIZIO ASSISTENZA PILOTI</h4>
      ...
      <footer className="bg-slate-900 text-white/80 py-12 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center sm:text-left flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-300/60">Il merchandising aeronautico moderno per veri esperti e appassionati di volo.</p>
          </div>
          
          <div className="text-xs text-slate-300/40 font-mono">
